      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-sm max-w-xs">
              DeclaraJá: Organize seus bens, direitos e documentos fiscais para 
              uma declaração de imposto de renda simplificada.
            </p>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-sm text-gray-400 xl:text-center">
            &copy; {currentYear} DeclaraJá. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
